...
class Register @Inject()(config: ApplicationConfig, ggAction: xxx) extends PropertyLinkingController with ServicesConfig {
  ...
  def confirm = ggAction.async { _ => implicit request =>
