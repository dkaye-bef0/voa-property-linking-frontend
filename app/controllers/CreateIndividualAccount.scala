...
import connectors.{IdentityVerificationConnector, IndividualAccounts, VPLAuthConnector}
...
class CreateIndividualAccount(ggAction: GGAction,
  ...
  import CreateIndividualAccount._
